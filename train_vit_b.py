...
def train(args, model):
    ...
    if args.local_rank in [-1, 0]:
        ...
        writer = SummaryWriter(log_dir=os.path.join("logs_512", args.name))
    ...
    train_metric.to_csv('train_metric512.csv', index=False)
    test_metric.to_csv('test_metric512.csv', index=False)
...
def main():
    ...
    parser.add_argument("--output_dir", default="output_512", type=str,
